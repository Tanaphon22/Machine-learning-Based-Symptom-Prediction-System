...
4. **Model Evaluation**
   ...
   ในงานนี้เลือกใช้ Precision, Recall, F1-score ในการวัดผลของโมเดลโดยที่ใน test set จะได้ Macro avg Precision = 0.46, Macro avg Recall = 0.55, Macro avg F1-score = 0.47 จากผลที่ได้มานั้น โมเดลไม่สามารถเอาไปทำงานได้จริง
